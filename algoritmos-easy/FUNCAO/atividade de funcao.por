programa
{
 ...
 retorne falso |
	...
	calcula_passos funcao ()
	{
		escreva("calcular passos \n")
 const real um_passo_vale = 0. 82 anos
		quilomentros reais, quantidade_de_passos
 ...
 mídia = num1 + num2 / 2
	...
	calcular_imc funcao  ()
	{
		...
		peso real, altura, indice_de_massa_corporal
		...
		leia(altura)
		  ...
		  senao se(indice_de_massa_corporal <= 18. 49 anos)
		  {
		  	escreva("abaixo do peso")
		  }
		  senao se(indice_de_massa_corporal <= 24. 99 anos)
		  {
		  	escreva("peso normal")
		  }
		  senao se(indice_de_massa_corporal <= 29. 99 anos)
		  {
